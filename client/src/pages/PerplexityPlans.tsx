...
const data: ToolPageData = {
  ...
  plans: [
    {
      ...
      price: "৳499/month",
      delivery: "2–4 hours",
      seats: "Shared access — each session is independent",
      ...
      features: [
        ...
        "Visualisations: charts, diagrams, timelines",
  ...
  faqs: [
    ...
    { q: "Annual plan আছে কি?", a: "আমাদের কাছে monthly plan পাওয়া যায়। Annual plan-এর জন্য WhatsApp-এ জিজ্ঞেস করুন — আমরা সর্বোচ্চ সাশ্রয়ী option দেওয়ার চেষ্টা করি।" },
    { q: "Perplexity Assistant কী?", a: "Perplexity Assistant হলো voice-based AI mode যেখানে আপনি কথা বলে search করতে পারেন এবং AI voice-এ উত্তর দেয়। Mobile app-এ available।" },
    { q: "AI image generation কীভাবে কাজ করে?", a: "Pro plan-এ Perplexity-তে direct AI image generation করা যায়। Search করার পাশাপাশি visual content তৈরি করা সম্ভব।" },
