...
const SECTIONS = [
  {
    ...
    items: [
      ...
      { name: "Google AI Pro — Personal (2TB Drive)", price: "৳1,299/mo", href: "/tools/google-ai-pro", wa: waBase + enc("Hi, I want Google AI Pro Personal ৳1,299/mo") },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "Leonardo AI — Shared (8,500 tokens)", price: "৳349/mo", href: "/tools/leonardo", wa: waBase + enc("Hi, I want Leonardo AI Shared ৳349/mo") },
      { name: "Leonardo AI — Personal (25,000 tokens)", price: "৳1,299/mo", href: "/tools/leonardo", wa: waBase + enc("Hi, I want Leonardo AI Personal ৳1,299/mo") },
    ],
  },
  {
    ...
    items: [
      { name: "Runway ML Standard — Shared (625 credits)", price: "৳899/mo", href: "/tools/runway", wa: waBase + enc("Hi, I want Runway ML Standard Shared ৳899/mo") },
      { name: "Runway ML Pro — Shared (2,250 credits)", price: "৳1,799/mo", href: "/tools/runway", wa: waBase + enc("Hi, I want Runway ML Pro Shared ৳1,799/mo") },
      { name: "Kling AI Pro — Shared (660 credits)", price: "৳599/mo", href: "/tools/kling", wa: waBase + enc("Hi, I want Kling AI Pro Shared ৳599/mo") },
      { name: "Kling AI Premier — Shared (3,000 credits)", price: "৳1,499/mo", href: "/tools/kling", wa: waBase + enc("Hi, I want Kling AI Premier Shared ৳1,499/mo") },
    ],
  },
  {
