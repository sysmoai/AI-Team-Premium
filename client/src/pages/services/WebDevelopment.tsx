    ...
    <Layout>
      ...
      <section className="py-20" style={{ background: BRAND.sky }}>
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <a href="https://wa.me/8801533262758?text=Hi%2C+I%27m+interested+in+Web+Development+services+from+AI Team Premium" target="_blank" rel="noopener noreferrer" data-testid="button-hero-web" className="inline-flex items-center gap-2 rounded-full px-7 py-3.5 font-bold text-white text-base" style={{ background: "#25D366" }}>
      ...
      <section className="py-20" style={{ background: BRAND.navy }}>
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <a href="https://wa.me/8801533262758?text=Hi%2C+I%27m+interested+in+Web+Development+services+from+AI Team Premium" target="_blank" rel="noopener noreferrer" data-testid="button-final-cta-web" className="inline-flex items-center gap-3 rounded-full px-8 py-4 font-bold text-white text-lg" style={{ background: "#25D366" }}>
