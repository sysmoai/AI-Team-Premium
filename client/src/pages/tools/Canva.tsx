...
const CANVA_COMPETITOR_ROWS = [
  ...
  { feature: "AI Team Premium (Shared)", thisProduct: "৳599/mo", chatgpt: "৳499/mo", claude: "৳1,495/mo", gemini: "৳899/mo" },
];
...
const CANVA_FAQS = [
  ...
  { q: "How many people can share one Canva Pro team seat?", a: "For the Team Seat plan (৳599/mo), the seat is added to one Canva account. AI Team Premium manages this through a genuine team, so your seat is exclusive to you — others in the team don't affect your designs or brand kit. Your designs are private to your own account within the team." },
