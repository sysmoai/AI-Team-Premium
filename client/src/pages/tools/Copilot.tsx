...
const COPILOT_COMPETITOR_ROWS = [
  ...
  { feature: "AI Team Premium", thisProduct: "৳999/mo (Private)", chatgpt: "৳399/mo (text AI)", claude: "৳599/mo (text AI)", gemini: "৳449/mo (text AI)" },
];
...
const COPILOT_EXTENDED_FAQS = [
  ...
  { q: "How many developers can use one GitHub Copilot account?", a: "The GitHub Copilot plan from AI Team Premium (৳1,200/mo) is activated on your personal GitHub account — it's a single-user licence. This gives you Copilot across all your repositories, both personal and where you're a contributor. GitHub Copilot Business (multi-seat for teams) requires separate pricing — contact us on WhatsApp for team pricing." },
];
