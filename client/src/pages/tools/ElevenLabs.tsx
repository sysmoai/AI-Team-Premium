...
const ELEVENLABS_COMPETITOR_ROWS = [
  ...
  { feature: "AI Team Premium (Shared)", thisProduct: "৳699/mo (100K chars)", chatgpt: "৳499/mo (text AI only)", claude: "৳1,495/mo (text AI only)", gemini: "৳899/mo (text AI + basic TTS)" },
];
