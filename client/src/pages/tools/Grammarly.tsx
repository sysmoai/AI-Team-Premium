...
const GRAMMARLY_COMPETITOR_ROWS = [
  ...
  { feature: "AI Team Premium", thisProduct: "৳499/mo (private)", chatgpt: "৳499/mo", claude: "৳1,495/mo", gemini: "৳899/mo" },
];
...
const GRAMMARLY_EXTENDED_FAQS = [
  ...
  { q: "How is Grammarly Premium delivered by AI Team Premium?", a: "Grammarly Premium from AI Team Premium is upgraded directly on your own Grammarly account — we need your Grammarly email address. Delivery takes 1–2 hours after payment confirmation on WhatsApp. Your existing documents, account settings, and history are preserved. The upgrade is genuine and comes with a 30-day replacement warranty." },
];
