...
const GROK_FAQS = [
  ...
  { q: "Can SuperGrok generate videos?", a: "Yes. SuperGrok includes Grok Video — xAI's text-to-video and image-to-video generator (currently in beta). It produces short clips typically 5–10 seconds. This feature is evolving rapidly. Both Shared and Personal SuperGrok plans from AITP include Grok Video access, though the beta nature means occasional feature updates and changes." },
