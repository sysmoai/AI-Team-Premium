  ...
  return (
    <ToolDetail
      ...
      competitorRows={[
        ...
        { feature: "AI Team Premium (Shared)", thisProduct: "৳599/mo", chatgpt: "৳499/mo (text AI)", claude: "৳1,495/mo (text AI)", gemini: "৳899/mo (Google AI)" },
      ]}
      extendedFaqs={[
