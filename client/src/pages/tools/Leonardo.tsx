  ...
  return (
    <ToolDetail
      ...
      competitorRows={[
        ...
        { feature: "AI Team Premium (Shared)", thisProduct: "৳349/mo", chatgpt: "৳499/mo", claude: "৳1,495/mo", gemini: "৳899/mo" },
      ]}
      extendedFaqs={[
        ...
        { q: "How do I get started with Leonardo AI from AI Team Premium?", a: "Message AI Team Premium on WhatsApp (+880 1533-262758). We deliver the Artisan Shared plan credentials within 5–15 minutes of payment. Log in at leonardo.ai, and all 20+ models, the Canvas editor, ControlNet, and other Artisan features are immediately available. No additional setup needed." },
      ]}
    />
  );
}
