...
const LINKEDIN_COMPETITOR_ROWS = [
  ...
  { feature: "AI Team Premium (Career)", thisProduct: "৳999/mo", chatgpt: "৳499/mo (different tool)", claude: "৳1,495/mo (different tool)", gemini: "৳899/mo (different tool)" },
];
...
const LINKEDIN_FAQS = [
  ...
  { q: "Is LinkedIn Premium delivered to my own LinkedIn account?", a: "Yes. LinkedIn Premium Career (৳999/mo) and Business (৳1,800/mo) from AI Team Premium are upgraded directly on your own LinkedIn account — you keep all your connections, messages, and history. We need your LinkedIn email address to process the upgrade. Delivery takes 2–4 hours. After upgrade, you see the 'Premium' gold badge on your profile immediately." },
  { q: "Can I cancel LinkedIn Premium through AI Team Premium after one month?", a: "Yes. LinkedIn Premium from AI Team Premium is month-to-month — you pay for one month at a time via bKash or Nagad. You can choose not to renew after any month. Since it's a private upgrade on your own account, your LinkedIn data, connections, and history remain intact even if you downgrade to Free. Simply don't pay for the next month to revert." },
];
