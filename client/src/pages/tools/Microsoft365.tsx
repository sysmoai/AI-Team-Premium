...
const M365_COMPETITOR_ROWS = [
  ...
  { feature: "AI Team Premium (Shared)", thisProduct: "৳899/mo", chatgpt: "৳499/mo (text AI only)", claude: "৳1,495/mo (text AI only)", gemini: "৳899/mo (Google suite)" },
];
