...
const MIDJOURNEY_COMPETITOR_ROWS = [
  ...
  { feature: "AI Team Premium (Shared)", thisProduct: "৳1,299/mo", chatgpt: "৳399/mo", claude: "৳599/mo", gemini: "৳449/mo" },
];
