...
const VAULT_COMPETITOR_ROWS = [
  ...
  { feature: "AI Team Premium Bundle Price", thisProduct: "৳1,990/mo", chatgpt: "৳499/mo only", claude: "৳1,495/mo only", gemini: "৳899/mo only" },
];
  ...
  return (
    <ToolDetail
      ...
      features={[
        ...
        "Claude Pro — Claude Sonnet 3.5 with Extended Thinking & 200K context",
