...
import { BLOG_ROUTE_META } from "./blog-routes.js";
import { BUNDLE_PRICES } from "./bundle-prices.js";
...
export const ROUTE_META = {
  ...
  ...BLOG_ROUTE_META,
  "/": { title: `AI Team Premium — ChatGPT, Claude & AI Tools in Bangladesh | from ${bdt(P.catalogMin)}/mo`, description: `ChatGPT Plus, Claude Pro, Gemini, Midjourney, Canva and ${CATALOG_COPY.tools} premium AI tools for Bangladesh. Pay via bKash/Nagad. 5-30 min delivery. 30-day warranty.`, canonical: "https://www.aiteampremium.com/" },
  ...
  "/chatgpt-plans": { title: `ChatGPT Plans & Pricing in Bangladesh — from ${bdt(P.chatgptPlusShared)}/mo | AI Team Premium`, description: `Compare all ChatGPT plans: Plus Shared (${bdt(P.chatgptPlusShared)}/mo), Premium Shared (${bdt(P.chatgptPlusPremiumShared)}/mo), Personal (${bdt(P.chatgptPlusPersonal)}/mo), Business, and Pro. Pay via bKash/Nagad. 5-15 min delivery.`, canonical: "https://www.aiteampremium.com/chatgpt-plans" },
  "/chatgpt/plus-shared": { title: "ChatGPT Plus Shared — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy ChatGPT Plus Shared in Bangladesh. Pay via bKash/Nagad. 5-15 min delivery. Premium AI subscription from AI Team Premium.", canonical: "https://www.aiteampremium.com/chatgpt/plus-shared" },
  "/chatgpt/plus-premium-shared": { title: "ChatGPT Plus Premium Shared — Buy in Bangladesh | AI Team Premium", description: "Buy ChatGPT Plus Premium Shared in Bangladesh. Pay via bKash/Nagad. 5-15 min delivery.", canonical: "https://www.aiteampremium.com/chatgpt/plus-premium-shared" },
  ...
  "/chatgpt/business-shared": { title: "ChatGPT Team Shared — Buy in Bangladesh | AI Team Premium", description: "Buy ChatGPT Team Shared in Bangladesh. Pay via bKash/Nagad. 5-15 min delivery.", canonical: "https://www.aiteampremium.com/chatgpt/business-shared" },
  "/chatgpt/business-premium-shared": { title: "ChatGPT Team Premium Shared — Buy in Bangladesh | AI Team Premium", description: "Buy ChatGPT Team Premium Shared in Bangladesh. Pay via bKash/Nagad. 5-15 min delivery.", canonical: "https://www.aiteampremium.com/chatgpt/business-premium-shared" },
  ...
  "/chatgpt/pro-premium-shared": { title: "ChatGPT Pro Premium Shared — Buy in Bangladesh | AI Team Premium", description: "Buy ChatGPT Pro Premium Shared in Bangladesh. The most powerful plan. Pay via bKash/Nagad.", canonical: "https://www.aiteampremium.com/chatgpt/pro-premium-shared" },
  ...
  "/chatgpt/go-shared": { title: "ChatGPT Go Shared — Buy in Bangladesh | AI Team Premium", description: "Buy ChatGPT Go Shared in Bangladesh. Pay via bKash/Nagad. 5-15 min delivery.", canonical: "https://www.aiteampremium.com/chatgpt/go-shared" },
  "/claude-plans": { title: "Claude Pro Plans & Pricing in Bangladesh | AI Team Premium", description: "Buy Claude Pro (Sonnet 4.5 + Opus 4) in Bangladesh. Pay via bKash/Nagad. 5-15 min delivery.", canonical: "https://www.aiteampremium.com/claude-plans" },
  "/gemini-plans": { title: "Gemini Advanced Plans & Pricing in Bangladesh | AI Team Premium", description: "Buy Gemini Advanced (Gemini 3.0 Pro) in Bangladesh. Pay via bKash/Nagad. 5-15 min delivery.", canonical: "https://www.aiteampremium.com/gemini-plans" },
  "/grammarly-plans": { title: "Grammarly Premium Plans in Bangladesh | AI Team Premium", description: "Buy Grammarly Premium in Bangladesh. Pay via bKash/Nagad. 5-15 min delivery.", canonical: "https://www.aiteampremium.com/grammarly-plans" },
  "/canva-plans": { title: "Canva Pro Plans & Pricing in Bangladesh | AI Team Premium", description: "Buy Canva Pro in Bangladesh. Pay via bKash/Nagad. 5-15 min delivery.", canonical: "https://www.aiteampremium.com/canva-plans" },
  "/perplexity-plans": { title: "Perplexity Pro Plans in Bangladesh | AI Team Premium", description: "Buy Perplexity Pro in Bangladesh. Pay via bKash/Nagad. 5-15 min delivery.", canonical: "https://www.aiteampremium.com/perplexity-plans" },
  "/grok-plans": { title: "SuperGrok Plans & Pricing in Bangladesh | AI Team Premium", description: "Buy SuperGrok in Bangladesh. Pay via bKash/Nagad. 5-15 min delivery.", canonical: "https://www.aiteampremium.com/grok-plans" },
  "/ai-tools-vault": { title: `AI Tools Vault — ChatGPT + Claude + Gemini Bundle ${bdt(BUNDLE_PRICES.vault)}/mo | AI Team Premium`, description: `Get ChatGPT Plus, Claude Pro and Gemini Advanced together for ${bdt(BUNDLE_PRICES.vault)}/month in Bangladesh. Pay via bKash/Nagad. 6-hour delivery, 30-day warranty.`, canonical: "https://www.aiteampremium.com/ai-tools-vault" },
  ...
  "/pricing": { title: "Pricing — AI Subscriptions in Bangladesh | AI Team Premium", description: `Full pricing for all AI subscriptions in Bangladesh. ChatGPT from ${bdt(P.chatgptPlusShared)}/mo. Pay via bKash/Nagad. Prices shown in BDT.`, canonical: "https://www.aiteampremium.com/pricing" },
