...
export const ROUTE_META = {
  "/": { title: "AI Team Premium — ChatGPT, Claude & AI Tools in Bangladesh | ৳349+/mo", description: "Bangladesh's #1 AI subscription platform. ChatGPT Plus, Claude Pro, Gemini, Midjourney, Canva & 80+ premium AI tools. Pay via bKash/Nagad. 5-30 min delivery. 30-day warranty.", canonical: "https://www.aiteampremium.com/" },
  "/all-products": { title: "All Premium AI Products — Complete Catalog (80 Tools) | AI Team Premium", description: "Complete catalog of 80 premium AI subscriptions. ChatGPT, Claude, Google AI, Grok, Perplexity, Midjourney, Ideogram, Runway & more. Search, filter by brand/category. One-click WhatsApp ordering.", canonical: "https://www.aiteampremium.com/all-products" },
  "/products": { title: "All Premium AI Products — Complete Catalog (80 Tools) | AI Team Premium", description: "Complete catalog of 80 premium AI subscriptions. ChatGPT, Claude, Google AI, Grok, Perplexity, Midjourney, Ideogram, Runway & more. Search, filter by brand/category. One-click WhatsApp ordering.", canonical: "https://www.aiteampremium.com/products" },
