...
export const ROUTE_META = {
  ...
  ...CATEGORY_ROUTE_META,
  "/": { title: `ChatGPT & Premium AI Tools in Bangladesh — bKash & Nagad | AI Team Premium`, description: `Buy ChatGPT Plus, Claude Pro, Gemini Advanced and ${CATALOG_COPY.tools} premium AI tools in Bangladesh. Pay via bKash or Nagad — no international credit card needed. Current access model, availability, fulfillment timing and support terms are confirmed before purchase.`, canonical: "https://www.aiteampremium.com/" },
  ...
  "/chatgpt/plus-personal-seat": { title: "ChatGPT Plus Personal Seat — Buy in Bangladesh | AI Team Premium", description: "Buy ChatGPT Plus Personal Seat in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/chatgpt/plus-personal-seat" },
  ...
  "/chatgpt/go-personal": { title: "ChatGPT Go Personal — Buy in Bangladesh | AI Team Premium", description: "Buy ChatGPT Go Personal in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/chatgpt/go-personal" },
  ...
  "/about": { title: "About AI Team Premium — Independent AI Access & Enablement Platform", description: "AI Team Premium is an independent Bangladesh-focused AI access and enablement platform. Commercial terms are confirmed before purchase.", canonical: "https://www.aiteampremium.com/about" },
  ...
  "/refund-policy": { title: "Refund Policy — AI Team Premium", description: "AI Team Premium refund, recovery and replacement disclosure. Eligibility and timing are confirmed for the specific order before payment.", canonical: "https://www.aiteampremium.com/refund-policy" },
  ...
  "/contact": { title: "Contact AI Team Premium — WhatsApp, Messenger, Email", description: "Contact AI Team Premium for current availability, approved access model, payment instructions, support scope and next steps. Response and fulfillment timing vary by request.", canonical: "https://www.aiteampremium.com/contact" },
  "/tools/chatgpt": { title: "ChatGPT — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy ChatGPT in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/chatgpt" },
  "/tools/claude": { title: "Claude AI — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy Claude AI in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/claude" },
  "/tools/gemini": { title: "Gemini — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy Gemini in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/gemini" },
  "/tools/supergrok": { title: "SuperGrok — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy SuperGrok in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/supergrok" },
  "/tools/google-ai-pro": { title: "Google AI Pro — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy Google AI Pro in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/google-ai-pro" },
  "/tools/midjourney": { title: "Midjourney — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy Midjourney in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/midjourney" },
  "/tools/leonardo": { title: "Leonardo AI — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy Leonardo AI in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/leonardo" },
  "/tools/runway": { title: "Runway ML — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy Runway ML in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/runway" },
  "/tools/kling": { title: "Kling AI — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy Kling AI in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/kling" },
  "/tools/grammarly": { title: "Grammarly — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy Grammarly in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/grammarly" },
  "/tools/canva": { title: "Canva Pro — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy Canva Pro in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/canva" },
  "/tools/perplexity": { title: "Perplexity Pro — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy Perplexity Pro in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/perplexity" },
  "/tools/grok": { title: "Grok — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy Grok in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/grok" },
  "/tools/copilot": { title: "GitHub Copilot — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy GitHub Copilot in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/copilot" },
  "/tools/vault": { title: "AI Tools Vault — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy AI Tools Vault in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/vault" },
  "/tools/elevenlabs": { title: "ElevenLabs — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy ElevenLabs in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/elevenlabs" },
  "/tools/notion": { title: "Notion AI — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy Notion AI in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/notion" },
  "/tools/microsoft365": { title: "Microsoft 365 — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy Microsoft 365 in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/microsoft365" },
  "/tools/linkedin": { title: "LinkedIn Premium — Buy in Bangladesh with bKash | AI Team Premium", description: "Buy LinkedIn Premium in Bangladesh. Pay via bKash/Nagad. Current fulfillment timing is confirmed before payment.", canonical: "https://www.aiteampremium.com/tools/linkedin" },
...
export const DYNAMIC_PREFIXES = [
  ...
  { prefix: "/tools/", meta: { title: "AI Tools & Subscriptions in Bangladesh | AI Team Premium", description: "Premium AI subscriptions for Bangladesh. Pay with bKash or Nagad — no international card needed. Current access model, availability, fulfillment timing and support terms are confirmed before purchase.", canonical: "https://www.aiteampremium.com/all-products" } },
  ...
  { prefix: "/category/", meta: { title: "AI Tool Categories in Bangladesh | AI Team Premium", description: "Browse premium AI subscriptions by category. Pay with bKash or Nagad — no international card needed. Current access model, availability, fulfillment timing and support terms are confirmed before purchase.", canonical: "https://www.aiteampremium.com/all-products" } },
];
