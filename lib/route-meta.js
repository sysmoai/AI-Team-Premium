...
export const ROUTE_META = {
  ...
  ...CATEGORY_ROUTE_META,
  "/": { title: `Buy ChatGPT Plus in Bangladesh — from ${bdt(P.catalogMin)}/mo with bKash & Nagad | AI Team Premium`, description: `Buy ChatGPT Plus, Claude Pro, Gemini Advanced and ${CATALOG_COPY.tools} premium AI tools in Bangladesh. Pay via bKash or Nagad — no international credit card needed. Current access model, availability, fulfillment timing and support terms are confirmed before purchase.`, canonical: "https://www.aiteampremium.com/" },
