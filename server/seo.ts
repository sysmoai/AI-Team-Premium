...
const ROUTE_META: Record<string, RouteMeta> = {
  ...
  "/compare/:slug": { title: "Compare AI Tools — Side-by-Side Comparison | AIPT — AI Premium Tools", description: "Compare AI tools side-by-side. Detailed comparison of features, pricing, and capabilities.", canonical: "https://www.aiteampremium.com/compare" },
